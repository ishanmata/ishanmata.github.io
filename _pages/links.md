...
This page collects some interesting/useful links.

### Right to Information

[How to use the RTI Act effectively](https://www.youtube.com/watch?v=YMll5dnGH6I) A talk by former Central Information Commissioner Mr. Shailesh Gandhi. A very useful and beginner friendly resource.
...
Some useful FOSS are:
- [Ubuntu](https://ubuntu.com/) (Operating system)
- LibreOffice suite (relacement for MS Word/Excel etc)
- Firefox
- [Joplin](https://joplinapp.org/) (Note taking software)
- [Zotero](https://www.zotero.org/) (Bibliography management)
- K9 mail (Email client for mobiles and tablets)

### Mathematics and Physics
[MathOverflow](https://www.mathoverflow.net)

[n-Category cafe](https://ncatlab.org/)

[String Wiki](https://www.stringwiki.org)
